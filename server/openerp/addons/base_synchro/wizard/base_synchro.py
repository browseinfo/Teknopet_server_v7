...
class base_synchro(orm.TransientModel):
    ...
    def synchronize(self, cr, uid, server, object_, context=None):
        print '___________-,synchronize___________'
        '''
        ...
        if object_.action in ('u', 'b'):
            print '________if_______u_________'
        ...
        print '___________ids______',ids
        ...
        for idx, (dt, id, action) in enumerate(ids):
            ...
            print '____________--base_synchro__________',base_synchro
            record_fields = getattr(base_synchro,
                                    '_special_case_%s'.replace('.', '_')
                                    % model, [])
            print '___________record_fields______________',record_fields
            record = pool_src.get(model).read(cr, uid, [id], record_fields,
                                              context=context)[0]

            print '_________record_________',record
            ...
            self.meta = {}
        print '________end________synchronize_______'
        return True
    ...
    def upload_download(self, cr, uid, ids, context=None):
        print '_______________upload_download_______'
        '''
...
Exceptions:
            ...
            summary += '\n'.join(self.report)
            print '__________summary_______',summary
