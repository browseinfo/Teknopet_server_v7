...
class import_easy_utility_prices_wizard(osv.osv_memory):
    _name = 'import.easy.utility.prices.wizard'
    _description = 'Import Easy Utility Prices wizard'
    ...
    def create_pricelist(self, cr, uid, partner, name, contract_type_id,start_date,end_date,categ_name,context={}):
        ...
        if categ_name == 'Electricity':
            ...
            raise osv.except_osv(('Invalid Data!'),("You must select Gas category in pop up interface."))
        return res
    ...
    def import_file(self, cr, uid, ids, context={}):
        for self_obj in self.browse(cr, uid, ids, context=context):
            ...
            file_lst = parser.read_xls.parse_easy_utility_xls_file(file_name, cr.dbname,pricelist_name, self_obj)
            file_lst.append(file_name)
        for file in file_lst:
            os.remove(file)
        return True
    
import_easy_utility_prices_wizard()
