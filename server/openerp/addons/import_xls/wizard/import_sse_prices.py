...
class import_sse_prices_wizard(osv.osv_memory):
    _name = 'import.sse.prices.wizard'
    _description = 'Import SSE Prices wizard'
    ...
    _columns = {
                ...
                'duration': fields.selection([('1','1'),('2','2'),('3','3'),('4','4')], 'Duration', required=True),
                }
    ...
    def create_pricelist(self, cr, uid, partner, name, contract_type_id,start_date,end_date,categ_name,duration,context={}):
        ...
        if categ_name == 'Gas':
            ...
            res['GAS CONTRACT'] = default_data['name']
...
#             print "______pricelist_name________",pricelist_name
            ...
            if self_obj.categ_id and self_obj.categ_id.name == 'Gas':
                file_lst = parser.read_xls.parse_sse_xls_file(file_name, cr.dbname,pricelist_name, self_obj)
