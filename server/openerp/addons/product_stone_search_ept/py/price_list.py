...
class product_pricelist(osv.osv):
    ...
    def price_get_multi(self, cr, uid, pricelist_ids, products_by_qty_by_partner,lot_id=False, context=None):
    ...
    def price_get(self, cr, uid, ids, prod_id, qty, partner=None,lot_id=False, context=None):
        res_multi = self.price_get_multi(cr, uid, pricelist_ids=ids, products_by_qty_by_partner=[(prod_id, qty, partner)],lot_id = lot_id, context=context)
